...
export const PROFESSIONAL_SKILLS: SkillOption[] = [
  ...
  { en: "Machine Learning", ar: "التعلم الآلي", category: "computer" },
  ...
  { en: "Full Stack", ar: "المكدس الكامل", category: "computer" },
  { en: "HTML/CSS", ar: "إتش تي إم إل وسي إس إس", category: "computer" },
  { en: "Responsive Design", ar: "التصميم المستجيب", category: "computer" },
  { en: "UI/UX Design", ar: "تصميم واجهات المستخدم", category: "computer" },
  { en: "Figma", ar: "فيجما", category: "computer" },
  { en: "Adobe XD", ar: "أدوب إكس دي", category: "computer" },
  ...
  { en: "QA Testing", ar: "اختبار جودة البرامج", category: "computer" },
