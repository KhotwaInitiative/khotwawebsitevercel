...
export const SAUDI_UNIVERSITIES: UniversityOption[] = [
  ...
  { en: "Riyadh Elm University", ar: "جامعة الرياض الإلم" },
  { en: "Alfaisal University", ar: "جامعة الفيصل" },
  { en: "Gulf University for Science and Technology", ar: "جامعة الخليج للعلوم والتقنية" },
  { en: "Princess Nourah University for Women", ar: "جامعة الأميرة نورة للنساء" },
  { en: "Dar Al Uloom University", ar: "جامعة دار العلوم" },
  { en: "Al Yamamah University", ar: "جامعة اليمامة" },
  { en: "Effat University", ar: "جامعة عفت" },
  { en: "Saudi Arabia University of Science and Technology", ar: "جامعة المملكة العربية السعودية للعلوم والتقنية" },
  { en: "Other", ar: "أخرى" },
];
...
export const PROFESSIONAL_MAJORS: MajorOption[] = [
  ...
  { en: "Data Science", ar: "علوم البيانات", category: "computer" },
  { en: "Cybersecurity", ar: "أمن السيبر", category: "computer" },
